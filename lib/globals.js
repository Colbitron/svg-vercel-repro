...
export function cmsGraphQLFetch(config) {
	const { attempt, delay, maxAttempts, jitter, query, variables, revalidate, method, headers } = { attempt: 0, delay: 300, maxAttempts: 5, jitter: true, query: '', variables: {}, revalidate: 600, method: 'POST', headers: null, ...config };
